...
def get_args():
    ...
    parser.add_argument("phone", help="只支持手机号")
    parser.add_argument("password", help="仔细检查一下密码")
    parser.add_argument("-l", dest="PLAYLIST", nargs="*", help="自定义歌单")
    args = parser.parse_args()

    return {"phone": args.phone, "password": md5(args.password), "playlist": args.PLAYLIST}
...
class CloudMusic:
    ...
    def sign(self):
        ...
        if ret["code"] == 200:
            ...
            return "签到失败 " + str(ret["code"]) + "：" + str(ret["message"])
